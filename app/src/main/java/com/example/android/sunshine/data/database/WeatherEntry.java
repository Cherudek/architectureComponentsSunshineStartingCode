...
public class WeatherEntry {
    ...
    // This constructor is used by the OpenWeatherJsonParser code when it converts the JSON from
    // the mock weather server to WeatherEntry objects. And must be ignored by Room
    @Ignore
    ...
    // this second constructor is used by room.
